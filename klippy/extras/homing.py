...
class HomingMove:
    ...
    def _calc_endstop_rate(self, mcu_endstop, movepos, speed):
        ...
        move_d = math.sqrt(sum([d*d for d in axes_d[:8]]))
        move_t = move_d / speed
    ...
    def calc_toolhead_pos(self, kin_spos, offsets):
        ...
        return list(kin.calc_position(kin_spos))[:8] + thpos[8:]
...
class Homing:
    ...
    def home_rails(self, rails, forcepos, movepos):
        ...
        homing_axes = [axis for axis in range(8) if forcepos[axis] is not None]
