...
move_get_coord(struct move *m, double move_time)
{
    ...
    return (struct coord) {
        ...
        .d = m->start_pos.d + m->axes_r.d * move_dist };
}
...
{
    struct coord start_pos = { .x=start_pos_x, .y=start_pos_y, .z=start_pos_z, .w=start_pos_w,
                               .a=start_pos_a, .b=start_pos_b, .c=start_pos_c, .d=start_pos_d };
    struct coord axes_r = { .x=axes_r_x, .y=axes_r_y, .z=axes_r_z, .w=axes_r_w,
                            .a=axes_r_a, .b=axes_r_b, .c=axes_r_c, .d=axes_r_d };
    if (accel_t) {
